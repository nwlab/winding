 ...
 * compatible with the generic @ref yaa_temperature_if_t abstraction.
 *
 * The returned interface must be passed to
 * @ref yaa_temperature_init to obtain a temperature sensor handle.
 *
