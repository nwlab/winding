...
#ifndef RDNX_BOOTLOADER_H
#define RDNX_BOOTLOADER_H
 ...
 */
#define RDNX_BL_ADDRESS (uint32_t)0x08000000

/**
 * @brief Size of the bootloader section (32KB).
 */
#define RDNX_BL_SIZE (uint32_t)0x00008000
 ...
 */
#ifndef RDNX_APP_ADDRESS
#define RDNX_APP_ADDRESS (uint32_t)0x08010000
#endif
 ...
 */
#define RDNX_END_ADDRESS (RDNX_BL_ADDRESS + (rdnx_bootloader_flash_size() * 1024) - 1)

/**
 * @brief Start address for application NVRAM.
 * @note Default address is 0x08008000 unless overridden.
 */
#ifndef RDNX_INFO_ADDRESS
#define RDNX_INFO_ADDRESS (uint32_t)0x08008000
#endif

/**
 * @brief Address of the system memory (ST Bootloader).
 */
#define RDNX_SYSMEM_ADDRESS (uint32_t)0x1FFFD800
 ...
 */
#define RDNX_RAM_SIZE   (uint32_t)0x0020000 /* 128 kB */

/**
 * @brief Total flash size available in the MCU.
 */
#define RDNX_FLASH_SIZE (uint32_t)((FLASH_END) - (FLASH_BASE))

/**
 * @brief Size of the application in DWORD (32 bits or 4 bytes).
 */
#define RDNX_APP_SIZE (uint32_t)(((RDNX_END_ADDRESS - RDNX_APP_ADDRESS) + 1))
...
enum
{
    RDNX_BL_OK = 0, /**< Bootloader operation successful */
    RDNX_BL_NO_APP, /**< No application found in flash */
    RDNX_BL_SIZE_ERROR, /**< Invalid application size */
    RDNX_BL_CHKS_ERROR, /**< Checksum error */
    RDNX_BL_ERASE_ERROR, /**< Flash erase error */
    RDNX_BL_WRITE_ERROR, /**< Flash write error */
    RDNX_BL_OBP_ERROR /**< Operation block protection error */
};
...
enum
{
    RDNX_BL_PROTECTION_NONE = 0, /**< No protection */
    RDNX_BL_PROTECTION_WRP = 0x1, /**< Write protection */
    RDNX_BL_PROTECTION_RDP = 0x2, /**< Read-out protection */
    RDNX_BL_PROTECTION_PCROP = 0x4, /**< Peripheral control read-out protection */
};

/**
 * @brief Structure containing bootloader configuration parameters.
 */
typedef struct rdnx_bootloader_param
{
