...
#include <sensor/temperature/yaa_stm32_temp.h>
...
static yaa_err_t stm32_init(void *ctx);
static yaa_err_t stm32_read(void *ctx, yaa_temperature_t *value);

/* ============================================================================
 * Global Function Definition
 * ==========================================================================*/

yaa_temperature_if_t yaa_stm32_temp_init(const yaa_stm32_temperature_param_t *param)
{
...
static yaa_err_t stm32_init(void *ctx)
{
    const yaa_stm32_temperature_param_t *param = YAA_CAST(const yaa_stm32_temperature_param_t *, ctx);
 ...
 *
 * @return YAA_ERR_OK on success, YAA_ERR_BUSY if conversion not complete
 */
static yaa_err_t stm32_read(void *ctx, yaa_temperature_t *value)
{
    if (!ADCCMPLT)
    ...
    // Store result
    *value = (yaa_temperature_t)temp_centi;
